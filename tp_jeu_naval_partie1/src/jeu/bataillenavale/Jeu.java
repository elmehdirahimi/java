...
public class Jeu {
	 ...
	 * @throws TirCaseInexistante 
	 */
	public void tirs() throws TirCaseInexistante {
	 ...
	 * @throws ToutesCasesAffecteesException 
	 */
	public void placement() throws ToutesCasesAffecteesException {
	 ...
	 * @throws ToutesCasesAffecteesException 
	 */
	public void demarre() throws TirCaseInexistante, ToutesCasesAffecteesException {
		placement();
		tirs();
		if (joueur1.aPerdu()) {
	 ...
	 * @throws ToutesCasesAffecteesException 
	 */
	public static void main(String[] args) throws TirCaseInexistante, ToutesCasesAffecteesException {
